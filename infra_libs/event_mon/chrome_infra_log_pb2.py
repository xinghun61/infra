...
_BUILDEVENT = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='goma_stats', full_name='crit_event.proto.BuildEvent.goma_stats', index=8,
