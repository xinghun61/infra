...
_GOMASTATS = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='histogram', full_name='devtools_goma.GomaStats.histogram', index=10,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='machine_info', full_name='devtools_goma.GomaStats.machine_info', index=11,
