...
_sym_db.RegisterEnumDescriptor(_ISOLATECLIENTEVENT_OPERATION)
...
IsolateClientEvent = _reflection.GeneratedProtocolMessageType('IsolateClientEvent', (_message.Message,), dict(

  ArchiveDetails = _reflection.GeneratedProtocolMessageType('ArchiveDetails', (_message.Message,), dict(
...
_sym_db.RegisterMessage(IsolateClientEvent)
_sym_db.RegisterMessage(IsolateClientEvent.ArchiveDetails)
