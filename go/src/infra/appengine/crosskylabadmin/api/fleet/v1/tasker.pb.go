...
func (TaskType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_tasker_04203c2aa2045010, []int{0}
}
...
func (*TaskerBotTasks) Descriptor() ([]byte, []int) {
	return fileDescriptor_tasker_04203c2aa2045010, []int{1}
}
...
func (*TaskerTask) Descriptor() ([]byte, []int) {
	return fileDescriptor_tasker_04203c2aa2045010, []int{2}
}
...
func (*TriggerRepairOnIdleRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_tasker_04203c2aa2045010, []int{3}
}
...
func (*TriggerRepairOnRepairFailedRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_tasker_04203c2aa2045010, []int{4}
}
...
func (*EnsureBackgroundTasksRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_tasker_04203c2aa2045010, []int{5}
}
...
func init() {
	proto.RegisterFile("infra/appengine/crosskylabadmin/api/fleet/v1/tasker.proto", fileDescriptor_tasker_04203c2aa2045010)
}

var fileDescriptor_tasker_04203c2aa2045010 = []byte{
