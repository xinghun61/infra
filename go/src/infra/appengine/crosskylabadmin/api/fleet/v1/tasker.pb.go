...
type TaskerTasksResponse struct {
	...
	BotTasks             []*TaskerBotTasks `protobuf:"bytes,1,rep,name=bot_tasks,json=botTasks" json:"bot_tasks,omitempty"`
...
func (dst *TaskerTasksResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_TaskerTasksResponse.Merge(dst, src)
}
...
type TaskerBotTasks struct {
	...
	Tasks                []*TaskerTask `protobuf:"bytes,2,rep,name=tasks" json:"tasks,omitempty"`
	XXX_NoUnkeyedLiteral struct{}      `json:"-"`
	XXX_unrecognized     []byte        `json:"-"`
	XXX_sizecache        int32         `json:"-"`
}
...
func (dst *TaskerBotTasks) XXX_Merge(src proto.Message) {
	xxx_messageInfo_TaskerBotTasks.Merge(dst, src)
}
...
type TaskerTask struct {
	...
	Type TaskType `protobuf:"varint,2,opt,name=type,enum=crosskylabadmin.fleet.TaskType" json:"type,omitempty"`
	// task_url lists the URL to the Swarming task triggered.
	TaskUrl              string   `protobuf:"bytes,3,opt,name=task_url,json=taskUrl" json:"task_url,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (dst *TaskerTask) XXX_Merge(src proto.Message) {
	xxx_messageInfo_TaskerTask.Merge(dst, src)
}
...
type TriggerRepairOnIdleRequest struct {
	...
	// idle_timeout_seconds specifies the time (in seconds) for which a selected
	// bot must have been idle for a repair task to be created against it.
	IdleTimeoutSeconds int32 `protobuf:"varint,2,opt,name=idle_timeout_seconds,json=idleTimeoutSeconds" json:"idle_timeout_seconds,omitempty"`
...
func (dst *TriggerRepairOnIdleRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_TriggerRepairOnIdleRequest.Merge(dst, src)
}
...
func (m *TriggerRepairOnIdleRequest) GetIdleTimeoutSeconds() int32 {
	if m != nil {
...
type TriggerRepairOnRepairFailedRequest struct {
	...
	// If no selectors are provided, all bots are selected.
	Selectors []*BotSelector `protobuf:"bytes,1,rep,name=selectors" json:"selectors,omitempty"`
	// last_repair_timeout_seconds specifies the time (in seconds) that must
	// have elapsed since the last attempt to repair the failed bot for a repair
	// task to be created against it.
	LastRepairTimeoutSeconds int32 `protobuf:"varint,2,opt,name=last_repair_timeout_seconds,json=lastRepairTimeoutSeconds" json:"last_repair_timeout_seconds,omitempty"`
	// priority forces the tasks to be created at the given priority. Swarming
	// uses priorities in [0,255], where lower number means higher priority.
	//
	// priority should usually not be used by clients. Tasker creates tasks at
...
func (dst *TriggerRepairOnRepairFailedRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_TriggerRepairOnRepairFailedRequest.Merge(dst, src)
}
...
func (m *TriggerRepairOnRepairFailedRequest) GetLastRepairTimeoutSeconds() int32 {
	if m != nil {
		return m.LastRepairTimeoutSeconds
	}
	return 0
}
...
type EnsureBackgroundTasksRequest struct {
	...
	Type TaskType `protobuf:"varint,1,opt,name=type,enum=crosskylabadmin.fleet.TaskType" json:"type,omitempty"`
	...
	TaskCount int32 `protobuf:"varint,3,opt,name=task_count,json=taskCount" json:"task_count,omitempty"`
	// priority forces the tasks to be created at the given priority. Swarming
	// uses priorities in [0,255], where lower number means higher priority.
	//
	// priority should usually not be used by clients. Tasker creates tasks at
...
func (dst *EnsureBackgroundTasksRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_EnsureBackgroundTasksRequest.Merge(dst, src)
}
...
var fileDescriptor_tasker_061428ba9a0e88d4 = []byte{
	...
	,
}
