...
type FeedbackRequest struct {
	...
	// Must be before end_time. The format for both start_time and end_time is
	// RFC 3339, e.g. "2006-01-02T08:04:05Z".
	//
	// Optional field. Defaults to epoch start of time (Jan 1, 1970).
	StartTime string `protobuf:"bytes,2,opt,name=start_time,json=startTime,proto3" json:"start_time,omitempty"`
	// End of time period to report feedback for.
	//
	// Feedback from comments created before this time will be included. Must be
	// after start_time.
	//
...
var fileDescriptor_2738dd491b254f26 = []byte{
	...
	,
}
