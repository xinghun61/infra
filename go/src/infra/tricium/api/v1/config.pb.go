...
func (Acl_Role) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_config_269f3a29cd374bd5, []int{5, 0}
}
...
type ServiceConfig struct {
	...
	BuildbucketServer    string   `protobuf:"bytes,9,opt,name=buildbucket_server,json=buildbucketServer,proto3" json:"buildbucket_server,omitempty"`
...
func (*ServiceConfig) Descriptor() ([]byte, []int) {
	return fileDescriptor_config_269f3a29cd374bd5, []int{0}
}
...
func (m *ServiceConfig) GetBuildbucketServer() string {
	if m != nil {
...
func (*ProjectConfig) Descriptor() ([]byte, []int) {
	return fileDescriptor_config_269f3a29cd374bd5, []int{1}
}
...
func (*RepoDetails) Descriptor() ([]byte, []int) {
	return fileDescriptor_config_269f3a29cd374bd5, []int{2}
}
...
func (*GerritProject) Descriptor() ([]byte, []int) {
	return fileDescriptor_config_269f3a29cd374bd5, []int{3}
}
...
func (*GitRepo) Descriptor() ([]byte, []int) {
	return fileDescriptor_config_269f3a29cd374bd5, []int{4}
}
...
func (*Acl) Descriptor() ([]byte, []int) {
	return fileDescriptor_config_269f3a29cd374bd5, []int{5}
}
...
func (*Selection) Descriptor() ([]byte, []int) {
	return fileDescriptor_config_269f3a29cd374bd5, []int{6}
}
...
func (*Config) Descriptor() ([]byte, []int) {
	return fileDescriptor_config_269f3a29cd374bd5, []int{7}
}
...
func init() {
	proto.RegisterFile("infra/tricium/api/v1/config.proto", fileDescriptor_config_269f3a29cd374bd5)
}

var fileDescriptor_config_269f3a29cd374bd5 = []byte{
	// 740 bytes of a gzipped FileDescriptorProto
	,
}
