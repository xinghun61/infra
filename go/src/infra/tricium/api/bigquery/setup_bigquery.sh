...
# Configuration:
DATASET_DESC="Tricium server statistics"
DATASET=analyzer
TABLE=results
TABLE_PROTO_MSG=analyzer.results.AnalysisRun
...
# TODO(cmumford): The stock role "roles/bigquery.dataEditor" grants too much
