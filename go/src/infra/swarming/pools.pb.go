...
type PoolsCfg struct {
	...
	// Currently ignored. To be removed.
	ForbidUnknownPools bool `protobuf:"varint,2,opt,name=forbid_unknown_pools,json=forbidUnknownPools,proto3" json:"forbid_unknown_pools,omitempty"`
...
func (*PoolsCfg) Descriptor() ([]byte, []int) {
	return fileDescriptor_d753b24993348c9f, []int{0}
}
...
func (m *PoolsCfg) GetForbidUnknownPools() bool {
	if m != nil {
		return m.ForbidUnknownPools
	}
	return false
}
...
type Pool struct {
	...
	// If there are multiple items in this list, then the first one that matches
	// the dimension set of a given task or bot will be used for that task or bot.
...
func (*Pool) Descriptor() ([]byte, []int) {
	return fileDescriptor_d753b24993348c9f, []int{1}
}
...
func (*Pool) XXX_OneofFuncs() (func(msg proto.Message, b *proto.Buffer) error, func(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error), func(msg proto.Message) (n int), []interface{}) {
	return _Pool_OneofMarshaler, _Pool_OneofUnmarshaler, _Pool_OneofSizer, []interface{}{
		(*Pool_TaskTemplateDeployment)(nil),
		(*Pool_TaskTemplateDeploymentInline)(nil),
	}
}

func _Pool_OneofMarshaler(msg proto.Message, b *proto.Buffer) error {
	m := msg.(*Pool)
	// task_deployment_scheme
	switch x := m.TaskDeploymentScheme.(type) {
	case *Pool_TaskTemplateDeployment:
		b.EncodeVarint(6<<3 | proto.WireBytes)
		b.EncodeStringBytes(x.TaskTemplateDeployment)
	case *Pool_TaskTemplateDeploymentInline:
		b.EncodeVarint(7<<3 | proto.WireBytes)
		if err := b.EncodeMessage(x.TaskTemplateDeploymentInline); err != nil {
			return err
		}
	case nil:
	default:
		return fmt.Errorf("Pool.TaskDeploymentScheme has unexpected type %T", x)
	}
	return nil
}

func _Pool_OneofUnmarshaler(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error) {
	m := msg.(*Pool)
	switch tag {
	case 6: // task_deployment_scheme.task_template_deployment
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		x, err := b.DecodeStringBytes()
		m.TaskDeploymentScheme = &Pool_TaskTemplateDeployment{x}
		return true, err
	case 7: // task_deployment_scheme.task_template_deployment_inline
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		msg := new(TaskTemplateDeployment)
		err := b.DecodeMessage(msg)
		m.TaskDeploymentScheme = &Pool_TaskTemplateDeploymentInline{msg}
		return true, err
	default:
		return false, nil
	}
...
func _Pool_OneofSizer(msg proto.Message) (n int) {
	m := msg.(*Pool)
	// task_deployment_scheme
	switch x := m.TaskDeploymentScheme.(type) {
	case *Pool_TaskTemplateDeployment:
		n += 1 // tag and wire
		n += proto.SizeVarint(uint64(len(x.TaskTemplateDeployment)))
		n += len(x.TaskTemplateDeployment)
	case *Pool_TaskTemplateDeploymentInline:
		s := proto.Size(x.TaskTemplateDeploymentInline)
		n += 1 // tag and wire
...
func (*Schedulers) Descriptor() ([]byte, []int) {
	return fileDescriptor_d753b24993348c9f, []int{2}
}
...
func (*TrustedDelegation) Descriptor() ([]byte, []int) {
	return fileDescriptor_d753b24993348c9f, []int{3}
}
...
func (*TrustedDelegation_TagList) Descriptor() ([]byte, []int) {
	return fileDescriptor_d753b24993348c9f, []int{3, 0}
}
...
func (*TaskTemplate) Descriptor() ([]byte, []int) {
	return fileDescriptor_d753b24993348c9f, []int{4}
}
...
func (*TaskTemplate_CacheEntry) Descriptor() ([]byte, []int) {
	return fileDescriptor_d753b24993348c9f, []int{4, 0}
}
...
func (*TaskTemplate_CipdPackage) Descriptor() ([]byte, []int) {
	return fileDescriptor_d753b24993348c9f, []int{4, 1}
}
...
func (*TaskTemplate_Env) Descriptor() ([]byte, []int) {
	return fileDescriptor_d753b24993348c9f, []int{4, 2}
}
...
func (*TaskTemplateDeployment) Descriptor() ([]byte, []int) {
	return fileDescriptor_d753b24993348c9f, []int{5}
}
...
func (*BotMonitoring) Descriptor() ([]byte, []int) {
	return fileDescriptor_d753b24993348c9f, []int{6}
}
...
type ExternalSchedulerConfig struct {
	...
	// ["os:foo", "featureX:bar"]). A task or bot will use this external scheduler
	// if and only if the task or bot contains all of these dimensions.
	//
...
func (*ExternalSchedulerConfig) Descriptor() ([]byte, []int) {
	return fileDescriptor_d753b24993348c9f, []int{7}
}
...
func init() { proto.RegisterFile("pools.proto", fileDescriptor_d753b24993348c9f) }

var fileDescriptor_d753b24993348c9f = []byte{
	// 871 bytes of a gzipped FileDescriptorProto
	,
}
