...
type Update struct {
	...
	IsDescription bool `protobuf:"varint,13,opt,name=is_description,json=isDescription" json:"is_description,omitempty"`
}
...
type GetIssueRequest struct {
	Issue *IssueRef `protobuf:"bytes,1,opt,name=issue" json:"issue,omitempty"`
}
...
func (*GetIssueRequest) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{11} }
