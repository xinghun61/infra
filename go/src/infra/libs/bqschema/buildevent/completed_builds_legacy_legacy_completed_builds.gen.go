...
// LegacyCompletedBuildsTable is the TableDef for the
// "raw_events" dataset's "completed_builds_legacy" table.
var LegacyCompletedBuildsTable = &pb.TableDef{
	Dataset: pb.TableDef_RAW_EVENTS,
	TableId: "completed_builds_legacy",
}

// LegacyCompletedBuilds_Swarming is a record for the "swarming" field.
type LegacyCompletedBuilds_Swarming struct {
	// The host name.
...
// LegacyCompletedBuilds_Kitchen is a record for the "kitchen" field.
type LegacyCompletedBuilds_Kitchen struct {
	// The Kitchen package version.
	Version string `bigquery:"version"`
}

// LegacyCompletedBuilds_Recipes is a record for the "recipes" field.
type LegacyCompletedBuilds_Recipes struct {
...
// LegacyCompletedBuilds is the schema for "LegacyCompletedBuildsTable".
type LegacyCompletedBuilds struct {
	...
	Swarming *LegacyCompletedBuilds_Swarming `bigquery:"swarming"`

	// Kitchen information.
	Kitchen *LegacyCompletedBuilds_Kitchen `bigquery:"kitchen"`

	// Recipe information.
	Recipes *LegacyCompletedBuilds_Recipes `bigquery:"recipes"`
}
