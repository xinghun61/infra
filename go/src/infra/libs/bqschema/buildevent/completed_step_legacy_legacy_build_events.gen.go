...
// LegacyBuildEventsTable is the TableDef for the
// "raw_events" dataset's "completed_step_legacy" table.
var LegacyBuildEventsTable = &pb.TableDef{
	Dataset: pb.TableDef_RAW_EVENTS,
	TableId: "completed_step_legacy",
}

// LegacyBuildEvents is the schema for "LegacyBuildEventsTable".
type LegacyBuildEvents struct {
