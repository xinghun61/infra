...
RepoTye = enum_type_wrapper.EnumTypeWrapper(_REPOTYE)
...
_REPO.fields_by_name['repo_type'].enum_type = _REPOTYE
...
class RepoConfigs(_message.Message):
  __metaclass__ = _reflection.GeneratedProtocolMessageType
