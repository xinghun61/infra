...
from infra.libs.event_mon.chrome_infra_log_pb2 import BuildEvent
...
def send_build_event(event_type,
  ...
  Args:
    event_type (string): any name of enum BuildEvent.BuildEventType.
      (listed in infra.libs.event_mon.monitoring.BUILD_EVENT_TYPES)
  ...
  Keyword args:
    ...
    result (string): any name of enum BuildEvent.BuildResult.
      (listed in infra.libs.event_mon.monitoring.BUILD_RESULTS)
