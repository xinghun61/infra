...
_BUILDER = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='executable', full_name='buildbucket.Builder.executable', index=7,
...
_BUILDER.fields_by_name['executable'].message_type = common__pb2._EXECUTABLE
