...
_SETTINGSCFG = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='enable_luci_runner', full_name='buildbucket.SettingsCfg.enable_luci_runner', index=3,
...
_SWARMINGSETTINGS = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='user_packages', full_name='buildbucket.SwarmingSettings.user_packages', index=3,
...
_SETTINGSCFG.fields_by_name['enable_luci_runner'].message_type = _BUILDERPREDICATE
