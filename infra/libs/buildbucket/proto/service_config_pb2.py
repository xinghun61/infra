...
_SETTINGSCFG = _descriptor.Descriptor(
    ...
    fields=[
        ...
        _descriptor.FieldDescriptor(
            name='logdog',
            full_name='buildbucket.SettingsCfg.logdog',
            index=1,
            number=2,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name='known_public_gerrit_hosts',
            full_name='buildbucket.SettingsCfg.known_public_gerrit_hosts',
            index=2,
            number=3,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name='enable_luci_runner',
            full_name='buildbucket.SettingsCfg.enable_luci_runner',
            index=3,
            number=5,
            type=11,
            cpp_type=10,
...
_SWARMINGSETTINGS_PACKAGE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='package_name',
            full_name='buildbucket.SwarmingSettings.Package.package_name',
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name='version',
            full_name='buildbucket.SwarmingSettings.Package.version',
            index=1,
            number=2,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name='version_canary',
            full_name='buildbucket.SwarmingSettings.Package.version_canary',
            index=2,
            number=3,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name='builders',
            full_name='buildbucket.SwarmingSettings.Package.builders',
            index=3,
            number=4,
            type=11,
            cpp_type=10,
...
_SWARMINGSETTINGS = _descriptor.Descriptor(
    ...
    fields=[
        ...
        _descriptor.FieldDescriptor(
            name='global_caches',
            full_name='buildbucket.SwarmingSettings.global_caches',
            index=2,
            number=4,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name='user_packages',
            full_name='buildbucket.SwarmingSettings.user_packages',
            index=3,
            number=5,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name='luci_runner_package',
            full_name='buildbucket.SwarmingSettings.luci_runner_package',
            index=4,
            number=6,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name='buildbucket.SwarmingSettings.kitchen_package',
            index=5,
            number=7,
            type=11,
            cpp_type=10,
...
_LOGDOGSETTINGS = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='hostname',
            full_name='buildbucket.LogDogSettings.hostname',
            index=0,
            number=1,
            type=9,
            cpp_type=9,
...
_BUILDERPREDICATE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='regex',
            full_name='buildbucket.BuilderPredicate.regex',
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name='regex_exclude',
            full_name='buildbucket.BuilderPredicate.regex_exclude',
            index=1,
            number=2,
            type=9,
            cpp_type=9,
...
_SETTINGSCFG.fields_by_name['enable_luci_runner'
                           ].message_type = _BUILDERPREDICATE
_SWARMINGSETTINGS_PACKAGE.fields_by_name['builders'
                                        ].message_type = _BUILDERPREDICATE
_SWARMINGSETTINGS_PACKAGE.containing_type = _SWARMINGSETTINGS
_SWARMINGSETTINGS.fields_by_name[
    'global_caches'].message_type = project__config__pb2._BUILDER_CACHEENTRY
_SWARMINGSETTINGS.fields_by_name['user_packages'
                                ].message_type = _SWARMINGSETTINGS_PACKAGE
_SWARMINGSETTINGS.fields_by_name['luci_runner_package'
                                ].message_type = _SWARMINGSETTINGS_PACKAGE
_SWARMINGSETTINGS.fields_by_name['kitchen_package'
                                ].message_type = _SWARMINGSETTINGS_PACKAGE
...
LogDogSettings = _reflection.GeneratedProtocolMessageType(
    'LogDogSettings',
    (_message.Message,),
    dict(
...
BuilderPredicate = _reflection.GeneratedProtocolMessageType(
    'BuilderPredicate',
    (_message.Message,),
    dict(
