...
_SPEC_CREATE_SOURCE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='patch_dir', full_name='Spec.Create.Source.patch_dir', index=4,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='unpack_archive', full_name='Spec.Create.Source.unpack_archive', index=5,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='no_archive_prune', full_name='Spec.Create.Source.no_archive_prune', index=6,
