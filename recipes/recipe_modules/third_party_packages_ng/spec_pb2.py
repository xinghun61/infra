...
_SPEC_CREATE_BUILD = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='tool', full_name='Spec.Create.Build.tool', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='dep', full_name='Spec.Create.Build.dep', index=1,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='install', full_name='Spec.Create.Build.install', index=2,
