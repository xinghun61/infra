...
_BUILDER_RECIPE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='cipd_package', full_name='buildbucket.Builder.Recipe.cipd_package', index=2,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='cipd_version', full_name='buildbucket.Builder.Recipe.cipd_version', index=3,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='properties', full_name='buildbucket.Builder.Recipe.properties', index=4,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='properties_j', full_name='buildbucket.Builder.Recipe.properties_j', index=5,
...
_BUILDER = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='expiration_secs', full_name='buildbucket.Builder.expiration_secs', index=8,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='caches', full_name='buildbucket.Builder.caches', index=9,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='build_numbers', full_name='buildbucket.Builder.build_numbers', index=10,
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='experimental', full_name='buildbucket.Builder.experimental', index=13,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='luci_migration_host', full_name='buildbucket.Builder.luci_migration_host', index=14,
