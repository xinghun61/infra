...
_SWARMING_BUILDER = _descriptor.Descriptor(
  ...
  nested_types=[_SWARMING_BUILDER_CIPDPACKAGE, ],
  enum_types=[
  ],
  options=None,
  is_extendable=False,
