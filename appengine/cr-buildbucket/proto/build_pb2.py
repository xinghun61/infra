...
_BUILD_INPUT = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='gitiles_commits', full_name='buildbucket.v2.Build.Input.gitiles_commits', index=1,
...
_BUILDINFRA = _descriptor.Descriptor(
  ...
  nested_types=[_BUILDINFRA_BUILDBUCKET, _BUILDINFRA_SWARMING, ],
  enum_types=[
  ],
  options=None,
  is_extendable=False,
...
_BUILDER_ID = _descriptor.Descriptor(
  name='ID',
  full_name='buildbucket.v2.Builder.ID',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='project', full_name='buildbucket.v2.Builder.ID.project', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='bucket', full_name='buildbucket.v2.Builder.ID.bucket', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='builder', full_name='buildbucket.v2.Builder.ID.builder', index=2,
      number=3, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_BUILDER = _descriptor.Descriptor(
  name='Builder',
  full_name='buildbucket.v2.Builder',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
...
_BUILD_INPUT.fields_by_name['gitiles_commits'].message_type = common__pb2._GITILESCOMMIT
...
_BUILD.fields_by_name['builder'].message_type = _BUILDER_ID
...
_BUILDER_ID.containing_type = _BUILDER
...
Builder = _reflection.GeneratedProtocolMessageType('Builder', (_message.Message,), dict(
  ...
  ID = _reflection.GeneratedProtocolMessageType('ID', (_message.Message,), dict(
    DESCRIPTOR = _BUILDER_ID,
    __module__ = 'build_pb2'
    # @@protoc_insertion_point(class_scope:buildbucket.v2.Builder.ID)
    ))
  ,
  DESCRIPTOR = _BUILDER,
  __module__ = 'build_pb2'
  # @@protoc_insertion_point(class_scope:buildbucket.v2.Builder)
  ))
_sym_db.RegisterMessage(Builder)
_sym_db.RegisterMessage(Builder.ID)
