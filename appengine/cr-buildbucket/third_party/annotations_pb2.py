...
_STEP_COMMAND_ENVIRONENTRY = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='key',
            full_name='milo.Step.Command.EnvironEntry.key',
            index=0,
            number=1,
            type=9,
            cpp_type=9,
...
_STEP_COMMAND = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='command_line',
            full_name='milo.Step.Command.command_line',
            index=0,
            number=1,
            type=9,
            cpp_type=9,
...
_STEP_SUBSTEP = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='step',
            full_name='milo.Step.Substep.step',
            index=0,
            number=1,
            type=11,
            cpp_type=10,
...
_STEP_PROGRESS = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='total',
            full_name='milo.Step.Progress.total',
            index=0,
            number=1,
            type=5,
            cpp_type=1,
...
_STEP_PROPERTY = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='name',
            full_name='milo.Step.Property.name',
            index=0,
            number=1,
            type=9,
            cpp_type=9,
...
_LOGDOGSTREAM = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='server',
            full_name='milo.LogdogStream.server',
            index=0,
            number=1,
            type=9,
            cpp_type=9,
...
_ISOLATEOBJECT = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='server',
            full_name='milo.IsolateObject.server',
            index=0,
            number=1,
            type=9,
            cpp_type=9,
...
FailureDetails = _reflection.GeneratedProtocolMessageType(
    'FailureDetails',
    (_message.Message,),
    dict(
...
Step = _reflection.GeneratedProtocolMessageType(
    ...
    dict(
        Command=_reflection.GeneratedProtocolMessageType(
            ...
            (_message.Message,),
            dict(
                EnvironEntry=_reflection.GeneratedProtocolMessageType(
                    'EnvironEntry',
                    (_message.Message,),
                    dict(
