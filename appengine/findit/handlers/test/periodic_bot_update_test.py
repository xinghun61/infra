...
class PeriodicBotUpdateTest(wf_testcase.WaterfallTestCase):
  ...
  def testTriggerUpdateJobs(self, mock_trigger, mock_get_bots):
    mock_get_bots.return_value = [{'bot_id': 'bot_1'},
                                  {'bot_id': 'bot_2', 'task_id': '1'}]
