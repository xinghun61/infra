...
_MOVEISSUERESPONSE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='moved_issue_ref', full_name='monorail.MoveIssueResponse.moved_issue_ref', index=0,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_MOVEISSUERESPONSE.fields_by_name['moved_issue_ref'].message_type = api_dot_api__proto_dot_common__pb2._ISSUEREF
