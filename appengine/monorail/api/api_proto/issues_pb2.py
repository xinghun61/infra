...
_FLAGISSUEREQUEST = _descriptor.Descriptor(
  name='FlagIssueRequest',
  full_name='monorail.FlagIssueRequest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='trace', full_name='monorail.FlagIssueRequest.trace', index=0,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='issue_ref', full_name='monorail.FlagIssueRequest.issue_ref', index=1,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='flag', full_name='monorail.FlagIssueRequest.flag', index=2,
      number=3, type=8, cpp_type=7, label=1,
      has_default_value=False, default_value=False,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_FLAGISSUERESPONSE = _descriptor.Descriptor(
  name='FlagIssueResponse',
  full_name='monorail.FlagIssueResponse',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
...
_FLAGISSUEREQUEST.fields_by_name['trace'].message_type = api_dot_api__proto_dot_common__pb2._REQUESTTRACE
_FLAGISSUEREQUEST.fields_by_name['issue_ref'].message_type = api_dot_api__proto_dot_common__pb2._ISSUEREF
...
DESCRIPTOR.message_types_by_name['FlagIssueRequest'] = _FLAGISSUEREQUEST
DESCRIPTOR.message_types_by_name['FlagIssueResponse'] = _FLAGISSUERESPONSE
...
FlagIssueRequest = _reflection.GeneratedProtocolMessageType('FlagIssueRequest', (_message.Message,), dict(
  DESCRIPTOR = _FLAGISSUEREQUEST,
  __module__ = 'api.api_proto.issues_pb2'
  # @@protoc_insertion_point(class_scope:monorail.FlagIssueRequest)
  ))
_sym_db.RegisterMessage(FlagIssueRequest)

FlagIssueResponse = _reflection.GeneratedProtocolMessageType('FlagIssueResponse', (_message.Message,), dict(
  DESCRIPTOR = _FLAGISSUERESPONSE,
  __module__ = 'api.api_proto.issues_pb2'
  # @@protoc_insertion_point(class_scope:monorail.FlagIssueResponse)
  ))
_sym_db.RegisterMessage(FlagIssueResponse)
