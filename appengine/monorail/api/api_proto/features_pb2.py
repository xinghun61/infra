...
_DISMISSCUEREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='cue_id', full_name='monorail.DismissCueRequest.cue_id', index=0,
