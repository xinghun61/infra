...
export const actionCreator = {
  ...
  fetchBlockerReferences: (dispatch, issue) => {
    ...
    const listReferencedIssues =  window.prpcCall(
  ...
  fetchIssue: (dispatch, message) => {
    ...
    const getIssue = window.prpcCall(
  ...
  fetchIssueHotlists: (dispatch, issue) => {
    ...
    const getIssueHotlists = window.prpcCall(
  ...
  fetchUserHotlists: (dispatch, user) => {
    ...
    const getUserHotlists = window.prpcCall(
  ...
  fetchIssuePermissions: (dispatch, message) => {
    ...
    const getIssuePermissions = window.prpcCall(
  ...
  fetchComments: (dispatch, message) => {
    ...
    const getComments = window.prpcCall(
  ...
  fetchIsStarred: (dispatch, message) => {
    ...
    const getIsStarred = window.prpcCall(
