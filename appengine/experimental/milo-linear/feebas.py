...
class FeebasApi(remote.Service):
  ...
  def get_topbar(data):
    if not data['times'][1]:
      ...
      status_text = 'This build passed successfully! :D'
      status_class = 'success'
    else:
      status_text = 'Failure'
      status_class = 'failure'
    return MiloItem(main_text=status_text, status=status_class)
