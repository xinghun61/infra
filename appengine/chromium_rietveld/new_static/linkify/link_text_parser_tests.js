...
describe("LinkTextParser", function() {
    ...
    it("should parse BUG= lines", function() {
        expectTokens("abc\n baz \nBUG=123 \nfoo bar", [
            "abc\n baz \n",
            "BUG=",
            {href:"https://bugs.chromium.org/p/chromium/issues/detail?id=123", text:"123"},
            " ",
            "\nfoo bar",
        ]);
    });
    it("should parse links and BUG= lines", function() {
        expectTokens("abc\n http://www.google.com/ baz \nBUG=456 \nfoo bar", [
            ...
            " baz \n",
            "BUG=",
            {href:"https://bugs.chromium.org/p/chromium/issues/detail?id=456", text:"456"},
            " ",
            "\nfoo bar",
        ]);
    });
    it("should parse multiple bugs in a BUG= line", function() {
        expectTokens("abc\nBUG=456, 678", [
            ...
            {href:"https://bugs.chromium.org/p/chromium/issues/detail?id=456", text:"456"},
            ", ",
            {href:"https://bugs.chromium.org/p/chromium/issues/detail?id=678", text:"678"},
        ]);
    });
    it("should parse tracker prefix in a BUG= line", function() {
        expectTokens("abc\nBUG=456,   v8:678,monorail:123456", [
            "abc\n",
            "BUG=",
            {href:"https://bugs.chromium.org/p/chromium/issues/detail?id=456", text:"456"},
            ",   ",
            {href:"https://bugs.chromium.org/p/v8/issues/detail?id=678", text:"v8:678"},
            ",",
            {href:"https://bugs.chromium.org/p/monorail/issues/detail?id=123456", text:"monorail:123456"},
        ]);
    });
    it("should parse both codesite and monorail trackers in a BUG= line", function() {
        expectTokens("abc\nBUG=chromium:123456,chromium-os:789", [
            "abc\n",
            "BUG=",
            {href:"https://bugs.chromium.org/p/chromium/issues/detail?id=123456", text:"chromium:123456"},
            ",",
            {href:"https://code.google.com/p/chromium-os/issues/detail?id=789", text:"chromium-os:789"},
        ]);
    });
