...
describe("SyntaxHighlighter", function() {
    ...
    it("should support embedded script", function() {
        ...
        assert.equal(highlighter.parseText('new F(); document'), '<span class="hljs-keyword">new</span> F(); <span class="hljs-built_in">document</span>');
        assert.equal(highlighter.parseText("</script>"), '<span class="hljs-tag">&lt;/<span class="hljs-title">script</span>&gt;</span>');
    });
    ...
    it("should support embedded style", function() {
        ...
        assert.equal(highlighter.parseText('.foo { color: "<style>"; }'), '<span class="hljs-class">.foo</span> <span class="hljs-rules">{ <span class="hljs-rule"><span class="hljs-attribute">color</span>:<span class="hljs-value"> <span class="hljs-string">"&lt;style&gt;"</span></span></span>; <span class="hljs-rule">}</span></span>');
        assert.equal(highlighter.parseText("</style>"), '<span class="hljs-tag">&lt;/<span class="hljs-title">style</span>&gt;</span>');
    });
});
